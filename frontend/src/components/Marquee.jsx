...
export default function Marquee() {
  ...
  return (
    <section data-testid="editorial-marquee" className="relative overflow-hidden border-y border-slate-200 bg-white py-10 sm:py-14">
          ...
          <span key={i} className="flex items-center gap-10">
            <span
              className={`font-display text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl ${
                i % 2 === 0 ? "text-outline-dark" : "text-[#0B1220]"
              }`}
            >
              {w}
            </span>
